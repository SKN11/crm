...
//@Configuration
@RestController
//@CrossOrigin(origins="http://localhost:3000")   // use for cross origin policy
//@CrossOrigin(origins="https://unruffled-panini-ef3ed9.netlify.app/")   // use for cross origin policy
@CrossOrigin
@RequestMapping("/api")
